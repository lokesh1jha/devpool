      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-full bg-gray-800 z-10">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <MobileNavLink href="/jobseeker" onClick={() => setIsOpen(false)}>
              For Developers
            </MobileNavLink>
            <MobileNavLink href="/employer" onClick={() => setIsOpen(false)}>
              For Employers
            </MobileNavLink>
            <MobileNavLink href="/jobs" onClick={() => setIsOpen(false)}>
              Browse Jobs
            </MobileNavLink>
          </div>
        </div>
